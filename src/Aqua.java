...
public class Aqua {
    ...
    static public void pomeshat(float a, float b, float c) {
        ...
        System.out.println("С концентрациями: " + " 100% в первой " + "во второй светлого: " + (1 - (c / (c + b))) * 100 + "% и темного: " + (c / (c + b)) * 100 + "%");
        float x = (c / (c + b)) * (c / (a - c)) + (1 - (c / (a - c)));
        float y = ((1 - (c / (c + b))) * ((c / (a - c))));
        System.out.println("После второго взмешивания концентрация первой тары составляет темного: " + x * 100 + "% а светлого: " + y * 100 + "%");
        ...
        float y2 = (c / (c + b)) * 100;
        System.out.println("Первого вещества: " + x2 + "% вещества: " + y2 + "%");
    }
    static class BlaBla {
